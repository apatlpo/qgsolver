...
class window():
    ...
    def __init__(self,
        ...
        mask_file: str, optional
            Links to mask file, overrides looking in hgrid_file
        mask3D: boolean, optional
            ???
        K : float, optional
            wavenumber, default = 1.e-6
        ...
        self.mask3D=mask3D
        if mask_file==None:
            mask_file = self.grid.hgrid_file
        self.grid.load_mask(mask_file,
                            self.da,
                            mask3D=self.mask3D,
                            )
...
class wininversion():
    ...
    def __init__(self, win):
        ...
        if win.grid._flag_hgrid_uniform and win.grid._flag_vgrid_uniform:
            self._set_L_uniform(self.L, win)
        else:
