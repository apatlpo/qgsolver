...
if __name__ == "__main__":
    ...
    if  len(sys.argv) < 2:
        print '[syntaxe] : python create_input_nemo.py rundir runscript'
    ...
    metricsout = create_nc(RPATH+'input/nemo_metrics.nc', lon, lat, zt, zw)
    #
    dtype='f8'
    # 
    ...
    # store PV
    print "store pv"
    pvout = create_nc(RPATH+'input/nemo_pv.nc', lon, lat, zt, zw)
    #
    ...
    if old:
        ...
        psiout = create_nc(RPATH+'input/nemo_psi.nc', lon, lat, zt, zw)
    ...
    rhoout = create_nc(RPATH+'input/nemo_rho.nc', lon, lat, zt, zw)
